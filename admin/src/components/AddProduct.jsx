...
const AddProduct = () => {
  ...
  return (
    <div>
          <NavBar/>
      <div className="max-w-4xl mx-auto my-12 p-8 bg-white rounded-lg shadow-xl">
        ...
        <form onSubmit={addProductHandler} className="space-y-6">
          <div className="space-y-2">
            <label htmlFor="desc" className="block text-lg font-semibold text-gray-700">Product Name</label>
            <input
              type="text"
              id="desc"
              name="desc"
          ...
          <div className="space-y-2">
            <label htmlFor="files" className="block text-lg font-semibold text-gray-700">Product Image</label>
            <input
              accept='.png,.jpg,.jpeg'
              type="file"
              id="files"
          ...
          <p className='mt-4 text-center text-green-500 text-xl animate-bounce '>{response}</p>
          <button
            type="submit"
