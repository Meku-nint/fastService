...
const Feedback = () => {
  ...
  const deleteFeedbackHandler = async (feedbackId) => {
    try {
      const res = await axios.delete('https://devfastservice.onrender.com/abc/deleteFeedback', { data: { feedbackId } });
  ...
  useEffect(() => {
    ...
    const fetchFeedbacks = async () => {
      try {
        const res = await axios.get('https://devfastservice.onrender.com/abc/fetchFeedback');
