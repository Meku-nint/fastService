...
const SignInUp = () => {
  ...
  const loginHandler = async (e) => {
    ...
    setIsLoading(true);
    try {
      const res = await axios.post('https://fastservice.onrender.com/abc/loginuser', loginData);
      if (res.data.token) {
  ...
  const signupHandler = async(e) => {
    ...
    e.preventDefault();
    try {
      const res = await axios.post('https://fastservice.onrender.com/abc/signupuser', user);
